        ...
        <div id="editor">
            <form action="./../post/store" method="post" enctype="multipart/form-data">
                ...
                <div style="width: 100%;" class="mt-3 input-title mr-5">
                    <input style="width: 100%;" type="text" name="minitext" id="" placeholder="Mini text">
                </div>
                <div>
                    <label for="area">Input content</label>
                    <textarea id="area" class="input-title" style=" width: 100%; height: 22rem;" placeholder="Content" name="content"></textarea>
                </div>
